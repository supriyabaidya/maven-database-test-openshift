 ...
 */
package com.monitor.mavendbtestopenshift;
...
public class DatabaseConnectTest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DatabaseConnectTest</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DatabaseConnectTest at " + request.getContextPath() + "</h1>");
...
//                connection = DriverManager.getConnection("jdbc:mysql://mysql:3306/lllc", "user", "password");
                ...
                ex.printStackTrace();
                out.println("db.Main.main() : SQLException " + ex.toString());

            } catch (ClassNotFoundException ex) {
                ex.printStackTrace();
                out.println("db.Main.main() : ClassNotFoundException " + ex.toString());
            } finally {
                out.println("</br>db.Main.main() : finally java execution is completed ");
                out.println("</body>");
                out.println("</html>");
